...
- **AC3 (repos por composición) + AC7 "envelope viejo desde el motor nuevo"** → RECONCILIADO en la story (título/Story/AC3/AC7/Status reescritos al engine off-wire; sprint → in-progress). **RESUELTO D-1 (2026-06-11): el bloque de composición de repositorios (FR9, FR11 parcial, FR12) se trasladó íntegro a la Story 1.3 (PR3)** — reasignado en `epics.md` (FR Coverage Map + AC de la Story 1.3 + AR16 + estructura interna). Traza histórica; el trabajo vive ahora en la Story 1.3.
