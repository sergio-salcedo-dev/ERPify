...
- **AC3 (repos por composición) + AC7 "envelope viejo desde el motor nuevo"** → RECONCILIADO en la story (título/Story/AC3/AC7/Status reescritos al engine off-wire; sprint → in-progress). Decisión pendiente FUERA de esta historia: trasladar el bloque de composición de repositorios íntegro a PR3 o crear una historia intermedia específica.
