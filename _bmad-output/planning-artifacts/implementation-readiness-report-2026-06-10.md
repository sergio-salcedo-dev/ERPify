...
- **NFR-QUAL — Calidad**: resolución estructural (no supresión) de Sonar `php:S1448`; gates `php.stan` + `php.quality` (PHPMD sin baseline); regla de pureza de capa (colaboradores deterministas, readonly, sin estado; solo `DoctrineSearchEngine` toca Doctrine).
