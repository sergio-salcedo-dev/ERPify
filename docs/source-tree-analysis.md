...
│   │       ├── ErrorContract/      # RFC 9457 pipeline — [Domain] Exception taxonomy; [Application] ProblemDetails/RedactionDenylist; [Infrastructure] ProblemDetailsFactory + ProblemDetailsResponder + ExceptionResponder/RateLimitListener
...
| `api/src/Shared/ErrorContract/Application/`                   | `ProblemDetails` VO + framework-free redaction (`RedactionDenylist`, …)                                                                                                                                                                                                                                                                                                                                                                                |
...
| `api/src/Shared/ErrorContract/Infrastructure/Http/`           | `ProblemDetailsFactory` (single throwable→wire mapping site), `ProblemDetailsResponder`, `EventListener/ExceptionResponder`, `EventListener/RateLimitListener`                                                                                                                                                                                                                                                                                                      |
