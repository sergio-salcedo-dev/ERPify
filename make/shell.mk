...
#
# Selecting on the extension alone would leave three tracked scripts unlinted —
# `api/bin/sf`, `binaries/composer` and `binaries/sf` — and
...
# sh/bash shebang. `git grep` supplies the second half in ~50 ms over 3.8k files;
