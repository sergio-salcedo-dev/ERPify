...
pwa.upgrade: ## Force upgrade all dependencies to the latest versions (npm-check-updates). Uses --legacy-peer-deps because cross-major bumps routinely trip npm's strict peer resolver on transitive ranges.
