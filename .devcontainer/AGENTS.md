...
| Compose / Make | On the **host**, from the repo root: **`make docker.up`**, **`make app.dev`**, etc. Inside this container, use **`docker compose`** from **`/workspace`** if the Docker CLI/socket is available, or run Composer/PHP commands in **`/workspace/api`**. |
...
- **Repository-wide requirements:** [`docs-info/project-requirements.md`](../docs-info/project-requirements.md)
