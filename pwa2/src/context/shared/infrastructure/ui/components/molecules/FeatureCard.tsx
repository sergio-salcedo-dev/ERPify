...
export const FeatureCard: React.FC<FeatureCardProps> = ({
  ...
  return (
    <motion.div whileHover={{ scale: 1.02 }} className="feature-card">
      <Card className="feature-card__container bg-white rounded-3xl shadow-xl shadow-slate-200/50 border border-slate-100 flex flex-col items-center text-center overflow-hidden">
