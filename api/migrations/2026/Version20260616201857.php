...
final class Version20260616201857 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE bank_count (id SMALLINT DEFAULT 1 NOT NULL, total INT DEFAULT 0 NOT NULL, updated_at TIMESTAMP(6) WITH TIME ZONE NOT NULL, PRIMARY KEY (id))');
        $this->addSql('CREATE TABLE event_store (sequence BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL, event_id UUID NOT NULL, aggregate_id UUID NOT NULL, aggregate_type VARCHAR(120) NOT NULL, aggregate_version INT NOT NULL, event_name VARCHAR(190) NOT NULL, event_version SMALLINT DEFAULT 1 NOT NULL, payload JSONB NOT NULL, metadata JSONB NOT NULL, tenant_id UUID DEFAULT NULL, occurred_on TIMESTAMP(6) WITH TIME ZONE NOT NULL, recorded_on TIMESTAMP(6) WITH TIME ZONE NOT NULL, PRIMARY KEY (sequence))');
        ...
        $this->addSql('CREATE TABLE projection_checkpoint (name VARCHAR(120) NOT NULL, last_sequence BIGINT DEFAULT 0 NOT NULL, updated_at TIMESTAMP(6) WITH TIME ZONE NOT NULL, PRIMARY KEY (name))');
