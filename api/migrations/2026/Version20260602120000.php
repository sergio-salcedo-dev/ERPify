...
final class Version20260602120000 extends AbstractMigration
{
    ...
    {
        $this->addSql('CREATE TABLE bank_account (iban VARCHAR(34) NOT NULL, holder_name VARCHAR(255) NOT NULL, alias VARCHAR(100) DEFAULT NULL, currency VARCHAR(3) NOT NULL, bic VARCHAR(11) DEFAULT NULL, status SMALLINT NOT NULL, id UUID NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, bank_id UUID NOT NULL, PRIMARY KEY (id))');
