 ...
 * serialized object is this DTO, never an entity, and every field is a string the mapper
 * pre-formats. `occurredOn` is an ISO-8601 string at microsecond precision (forensic instant);
 ...
 * view; they belong to the investigation detail (story 4.2).
 */
