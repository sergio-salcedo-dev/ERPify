...
final readonly class ChangeUserRoles
{
     ...
     * aggregate.
     *
     * The resource type is reached through {@see FulfilIdentityErasure}'s own constant rather than spelled
     * here, and that is not a style choice: the type denotes a natural person, so the file declaring its
     * literal is the file the audit-resource registry names as obliged to erase it. A second spelling of it in
     * `src` would put this class forward as a second erasure owner it cannot be.
     *
