 ...
 * is a `204 No Content`.
 *
 * The controller is thin: the chained erasure (identity, reset tokens and recovery secret + anonymisation of
 * both audit axes, the rows it authored and those naming it + business-log anonymisation + session,
 * membership and invitation purge, atomic),
