...
final class InspectStoredIdentityIntegrityCommand extends Command
{
     ...
     */
    private const string AFFECTED_IDENTITY_COUNT_LINE = '%d identity(ies).';
    ...
    private function report(SymfonyStyle $io, StoredIdentityDrift $findings): void
    {
        ...
        if (0 !== $findings->malformedRoles) {
            ...
            $io->text(\sprintf(self::AFFECTED_IDENTITY_COUNT_LINE, $findings->malformedRoles));
            $io->note([
        ...
        if (0 !== $findings->unreadableCredentials) {
            ...
            $io->text(\sprintf(self::AFFECTED_IDENTITY_COUNT_LINE, $findings->unreadableCredentials));
            $io->note([
        ...
        if (0 !== $findings->admittedWithoutCredential) {
            ...
            $io->text(\sprintf(self::AFFECTED_IDENTITY_COUNT_LINE, $findings->admittedWithoutCredential));
            $io->note([
