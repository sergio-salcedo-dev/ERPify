...
{
    private const string RESET_PATH = '/reset-password';

    private const string SUBJECT = 'Restablece tu contraseña de ERPify';
    ...
    {
        $link = \rtrim($this->appBaseUrl, '/') . self::RESET_PATH . '?token=' . \rawurlencode($resetToken);
            ...
            <body style="margin:0;padding:24px;background:#f4f5f7;color:#111827;font-family:Arial,sans-serif;">
              <div style="max-width:520px;margin:0 auto;">
                <p style="font-size:16px;line-height:1.5;margin:0 0 16px;">
                  Has solicitado restablecer tu contraseña de <strong>ERPify</strong>.
                </p>
                <p style="font-size:16px;line-height:1.5;margin:0 0 24px;">
                  Define una nueva contraseña. El enlace caduca en una hora y cerraremos todas tus sesiones
