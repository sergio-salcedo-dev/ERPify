 ...
 *
 * The empty `type` falls through to the {@see Forbidden} marker default (`forbidden`), so its problem `type` is
 * deliberately generic — the specificity boundary is identity proof, and there is nothing the holder can do
 * about a deactivation from the login screen.
 */
