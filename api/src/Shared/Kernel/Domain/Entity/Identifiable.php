...
trait Identifiable
{
     ...
     * declaration here would claim the same erasure owner for all of their primary keys at once. Whether
     * an id denotes a person is decided per entity in `api/.person-reference-policy`, which is where
