 ...
 * under `\LogicException`, so the project's `Erpify\Shared\ErrorContract\Domain\Exception\DomainException`
...
final readonly class ExceptionResponder
{
    ...
    private function resolveLogLevel(ProblemDetails $problemDetails, Throwable $throwable): string
    {
        ...
        // so the project's `Erpify\Shared\ErrorContract\Domain\Exception\DomainException` (which
