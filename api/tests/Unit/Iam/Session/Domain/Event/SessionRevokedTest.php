 ...
 * @internal
 */
#[CoversClass(SessionRevoked::class)]
final class SessionRevokedTest extends TestCase
{
    ...
    private const string EVENT_ID = '0190c1d2-e3f4-7a5b-8c6d-1e2f3a4b5c6f';

    private const string OCCURRED_ON = '2026-07-10T09:30:00+00:00';
    ...
    public function itExposesItsStableIdentityAndCarriesTheSubjectUserId(): void
    {
        ...
        $this->assertSame('erpify.iam.session.revoked', $event::eventName());
    ...
    {
        $reconstructed = SessionRevoked::fromPrimitives(
            self::SESSION_ID,
            ['userId' => self::USER_ID],
            self::EVENT_ID,
            self::OCCURRED_ON,
