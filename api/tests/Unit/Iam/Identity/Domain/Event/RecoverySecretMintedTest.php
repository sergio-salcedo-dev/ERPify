 ...
 * @internal
 */
#[CoversClass(RecoverySecretMinted::class)]
final class RecoverySecretMintedTest extends TestCase
{
    ...
    public function itNamesTheUserAndCarriesNoPayload(): void
    {
        ...
        $event = new RecoverySecretMinted(self::USER_ID, self::EVENT_ID, new DateTimeImmutable(self::OCCURRED_ON));

        $this->assertSame('erpify.iam.identity.recovery-secret-minted', $event::eventName());
    ...
    public function fromPrimitivesReconstructsAnIdenticalEvent(): void
    {
        ...
        $reconstructed = RecoverySecretMinted::fromPrimitives(self::USER_ID, [], self::EVENT_ID, self::OCCURRED_ON);
