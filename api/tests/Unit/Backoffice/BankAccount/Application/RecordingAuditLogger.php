...
/**
 * Spy {@see AuditLogger} capturing every recorded action, so a test can assert exactly one access is
 * audited on a successful read (and none on a rejected one) with the expected action, level and resource.
 *
 * @internal
 */
