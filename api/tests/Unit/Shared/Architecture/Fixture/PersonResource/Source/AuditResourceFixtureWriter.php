...
namespace Erpify\Tests\Unit\Shared\Architecture\Fixture\PersonResource\Source;

use Erpify\Shared\Audit\Domain\AuditResource;

/**
 * The synthetic source tree the person-resource gate sweeps when it is driven over fixtures instead of
 * `src`. One writer of one type is all the derivation needs: with it, a fixture registry can hold a
