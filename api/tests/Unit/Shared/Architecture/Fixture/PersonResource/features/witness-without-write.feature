Feature: A witness that asserts an absence it never created
  ...
  # and would hold with the erasure deleted entirely. Vacuous by construction — and this repository has
  # already shipped a test that never created the divergence it then asserted away.
