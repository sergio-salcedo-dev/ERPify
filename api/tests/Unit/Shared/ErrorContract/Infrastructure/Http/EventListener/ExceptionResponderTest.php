...
final class ExceptionResponderTest extends TestCase
{
    ...
    {
        $sourcePath = \dirname(__DIR__, 7)
            . '/src/Shared/ErrorContract/Infrastructure/Http/EventListener/ExceptionResponder.php';
        ...
        $this->assertSame(
            1,
            \substr_count($contents, 'use Erpify\Shared\Http\Infrastructure\CorrelationIdListener;'),
