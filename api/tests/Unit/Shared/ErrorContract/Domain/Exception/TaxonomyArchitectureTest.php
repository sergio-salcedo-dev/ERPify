...
/**
 * Architecture guard for Erpify\Shared\ErrorContract\Domain\Exception: enforces that the taxonomy stays
...
final class TaxonomyArchitectureTest extends TestCase
{
    ...
    {
        $apiRoot = \dirname(__DIR__, 6);
        $dir = $apiRoot . '/src/Shared/ErrorContract/Domain/Exception';
        $files = \glob($dir . '/*.php');
