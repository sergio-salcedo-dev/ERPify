 ...
 * id (never by association), so this test-only factory resolves both ids from the referenced fixtures —
 * the domain factory keeps its typed contract and the YAML keeps naming the fixtures it depends on.
 */
final class MembershipFixtureFactory
{
    public static function create(User $user, Organization $organization): Membership
    {
