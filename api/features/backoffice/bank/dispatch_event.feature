Feature: Dispatch a bank domain event onto the outbox
  ...
  # Drives the outbox directly via "I dispatch" (no HTTP), exercising the EventHydrator reflection path
  # and the full publish -> consume -> ack -> notification + realtime pipeline against a crafted payload.
  Scenario: A dispatched bank-created event is consumed and produces the notification and realtime effects
    ...
    """
    {
      "bankId": "01970000-0000-7000-8000-000000000001",
    ...
    And The outbox event property "bankId" should be equal to "01970000-0000-7000-8000-000000000001"
