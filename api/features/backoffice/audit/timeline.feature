Feature: Investigate the audit timeline
  ...
  # actorErased, resourceErased}. Both erasure axes travel so a consumer can tell an anonymisation
  # pseudonym from a live identifier on either of them.
  Background:
    Given I execute the SQL query "TRUNCATE audit_log RESTART IDENTITY"
    And I execute the SQL query "INSERT INTO audit_log (id, level, action, actor_type, actor_id, correlation_id, resource_type, resource_id, metadata, ip, user_agent, actor_erased, resource_erased, occurred_on) VALUES ('0190a001-0000-7000-8000-000000000001','security','LOGIN','user','11111111-1111-7111-8111-111111111111','0190c000-0000-7000-8000-000000000000',NULL,NULL,'{}',NULL,NULL,false,false,'2026-03-01 12:00:00+00'), ('0190a001-0000-7000-8000-000000000002','activity','VIEW','user','11111111-1111-7111-8111-111111111111','0190c000-0000-7000-8000-000000000000',NULL,NULL,'{}',NULL,NULL,false,false,'2026-03-01 11:59:00+00'), ('0190a001-0000-7000-8000-000000000003','activity','SEARCH','anonymous',NULL,'0190c000-0000-7000-8000-000000000000',NULL,NULL,'{}',NULL,NULL,false,false,'2026-03-01 11:58:00+00'), ('0190a001-0000-7000-8000-000000000004','security','DENIED','anonymous',NULL,'0190c000-0000-7000-8000-000000000000',NULL,NULL,'{}',NULL,NULL,false,false,'2026-03-01 11:57:00+00')"
  ...
  Scenario: The timeline lists newest-first with the constant cursor-only envelope
    ...
    And the JSON nodes matching "data[*]" should have 11 children
    ...
    And the JSON nodes matching "data[*].resourceErased" should exist
