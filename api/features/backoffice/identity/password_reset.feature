...
Feature: Reset a forgotten password uniformly
  ...
  Scenario: A valid token for a suspended identity is walled and not consumed
    ...
    """
    { "token": "0190e1f2-a3b4-7c5d-8e6f-1a2b3c4d5e03.behat-suspended-reset-secret", "password": "brand-new-strong-password", "_token": "behat-stateless-csrf-nonce-000000" }
    """
    Then the response status code should be 403
    And the header "Content-Type" should contain "application/problem+json"
  ...
  Scenario: An expired, an unknown, a malformed and a non-uuid token are one indistinguishable invalid-token
    ...
    When I send a POST request to "/backoffice/reset-password" with body:
    """
    { "token": "0190e1f2-a3b4-7c5d-8e6f-1a2b3c4d5e02.behat-expired-reset-secret", "password": "brand-new-strong-password", "_token": "behat-stateless-csrf-nonce-000000" }
    """
    ...
    """
    { "token": "0190e1f2-a3b4-7c5d-8e6f-1a2b3c4d5eff.some-unknown-secret", "password": "brand-new-strong-password", "_token": "behat-stateless-csrf-nonce-000000" }
    """
    And the response status code should be 400
    And the JSON node "type" should be equal to "invalid-token"
    And I send a POST request to "/backoffice/reset-password" with body:
    """
    { "token": "not-a-selector-verifier-shape", "password": "brand-new-strong-password", "_token": "behat-stateless-csrf-nonce-000000" }
    """
    And the response status code should be 400
    And the JSON node "type" should be equal to "invalid-token"
    And I send a POST request to "/backoffice/reset-password" with body:
    """
    { "token": "not-a-uuid-selector.some-secret", "password": "brand-new-strong-password", "_token": "behat-stateless-csrf-nonce-000000" }
    """
    And the response status code should be 400
    And the JSON node "type" should be equal to "invalid-token"
  ...
  Scenario: A failed reset records no events and mutates nothing
    ...
    When I send a POST request to "/backoffice/reset-password" with body:
    """
    { "token": "0190e1f2-a3b4-7c5d-8e6f-1a2b3c4d5eee.some-unknown-secret", "password": "brand-new-strong-password", "_token": "behat-stateless-csrf-nonce-000000" }
    """
    Then the response status code should be 400
  ...
  Scenario: A valid reset changes the password, clears the lock, revokes every prior session and signs the user in
    ...
    When I send a POST request to "/backoffice/reset-password" with body:
    """
    { "token": "0190e1f2-a3b4-7c5d-8e6f-1a2b3c4d5e01.behat-valid-reset-secret", "password": "brand-new-strong-password", "_token": "behat-stateless-csrf-nonce-000000" }
    """
    ...
    And I send a POST request to "/backoffice/reset-password" with body:
    """
    { "token": "0190e1f2-a3b4-7c5d-8e6f-1a2b3c4d5e01.behat-valid-reset-secret", "password": "another-strong-password", "_token": "behat-stateless-csrf-nonce-000000" }
    """
    And the response status code should be 400
    And the JSON node "type" should be equal to "invalid-token"
