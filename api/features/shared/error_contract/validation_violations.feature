Feature: ValidationFailedException surfaces as a 422 Problem Details with a structured violations[] extension
  ...
  # Both validation-failed and invariant-violation now share the 422 status; they remain
  # distinguishable by `type` and by the presence/absence of the violations[] extension.
