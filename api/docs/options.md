...
| `FRANKENPHP_SITE_CONFIG`        | extra directives inside the site `php` handler block in `frankenphp/Caddyfile` (e.g. [`hot_reload`](https://frankenphp.dev/docs/hot-reload/) in dev — set in root `compose.override.yaml`) |               |
