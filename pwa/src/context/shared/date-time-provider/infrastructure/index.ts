import type { DateTimeProvider } from "../domain/DateTimeProvider";
...
export type { DateTimeProvider } from "../domain/DateTimeProvider";
export type { AddUnit, DurationUnit } from "../domain/DateTimeProvider";
