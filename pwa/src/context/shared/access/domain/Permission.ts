 ...
 *
 * Identity administration is not CRUD: the capabilities are invite, change-status, and the separate GDPR
 * erase — each its own permission, none of them a generic write or delete.
 */
