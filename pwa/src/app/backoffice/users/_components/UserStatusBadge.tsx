...
// DEACTIVATED and REVOKED are inert "off" states (neutral, not an app error) that
// the label — not the tone — tells apart; INVITED is informational — pending a
// first sign-in.
