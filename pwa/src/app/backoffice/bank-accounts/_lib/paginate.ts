// Page-size options for the global accounts list, all ≤ WIRE_MAX_LIMIT (100,
...
export function isBankAccountsPageSize(value: number): value is BankAccountsPageSize {
  return (BANK_ACCOUNTS_PAGE_SIZE_OPTIONS as readonly number[]).includes(value);
}
