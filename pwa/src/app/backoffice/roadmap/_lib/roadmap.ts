    ...
    modules: [
      ...
      },
      {
        ...
        submodules: [
          ...
          { name: "Documentos comerciales", note: "on top of core 0.8" },
          { name: "Lead scoring" },
    ...
    modules: [
      ...
      },
      {
        ...
        submodules: [
          ...
          { name: "Audit trail documental", note: "on top of 0.7" },
        ],
      },
      {
        code: "2.3",
        ...
        submodules: [
          ...
          { name: "Certification-based invoicing (progress billing)", note: "desde 1.3" },
    ...
    modules: [
      {
        ...
        submodules: [
          ...
          { name: "Compras por umbral", note: "with optional approval" },
          {
