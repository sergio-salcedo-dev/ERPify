...
export function BankAccountForm({
  ...
  const onSubmit = handleSubmit(async (values) => {
    ...
    // IBAN and BIC are both already canonicalised by the schema. No eager clear
    // here: a previous error stays visible during the retry and is replaced only
    // at the outcome (an explicit clear on success, a new failure through
    // setProblem).
    const bic = values.bic && values.bic !== "" ? values.bic : null;
